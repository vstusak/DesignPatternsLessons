// --Resolve logging to console for delete (we can't see anything) - on filters warning and higher was allowed - DONE
// Resolve Edit - add submit and save new data. We are api controller now. Continue with repo - DONE
