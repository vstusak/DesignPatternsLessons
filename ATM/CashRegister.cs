...
public class CashRegister
{
    ...
    public CashRegister(
        int amountOf5000Banknotes,
        int amountOf2000Banknotes,
        int amountOf1000Banknotes,
        int amountOf500Banknotes,
        int amountOf200Banknotes,
        int amountOf100Banknotes)
    {
